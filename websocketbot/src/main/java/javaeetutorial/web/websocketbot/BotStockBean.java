...
/**
 * Contém a lógica para o agente de bot para responder a mensagens
 *
 */
@Named
public class BotStockBean {
    ...
    /* Este método compara a mensagem de chat recebida com um conjunto de questões pré-definidas e retorna uma resposta chat */
